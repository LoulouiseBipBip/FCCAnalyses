...
# stacksig       = ['stack','nostack']
outdir         = '/eos/user/l/lberiet/ttZ_diff_results/plot_syst/'
plotStatUnc    = True

variables = ['HT']#'Z_ll_mass','Z_ll_pt', 'n_jets', 'dR_ll', 'n_bjets', 'n_leptons', 'HT', 'MET', 'Second_Pair_flavor', 'Z_ll_and_second_pairs_size', 'Second_Pair_mass']
...
extralabel['sel1_lep'] = "Sel 3 leptons"
