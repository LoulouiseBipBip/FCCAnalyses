...
def main():
    ...
    input_dir ="/eos/user/l/lberiet/ttZ_diff_results/tracks/final"
    hist_name = "pTjet_prompt_elec_vs_D0_sig_prompt_elec"  # Ensure this matches the 2D histogram name in analysis_final.py
    ...
    for proc in processes:
        ...
        input_file = os.path.join(input_dir, f"{proc}_pT_jet_histo.root")
        ...
        if combined_hist is None:
            ...
            combined_hist.SetTitle("Combined Q-binned pTjet_prompt_elec_vs_D0_sig_prompt_elec")
            combined_hist.GetXaxis().SetTitle("pT_{lep}/pT_{jet}")  # Ensure x-axis title is set correctly
            combined_hist.GetYaxis().SetTitle("D0_{lep}")  # Ensure y-axis title is set correctly
