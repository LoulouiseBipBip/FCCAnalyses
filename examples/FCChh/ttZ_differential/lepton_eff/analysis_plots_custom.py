...
variables = ["reco_truth_lep_dR","Iso_Prompt","Iso_Non_Prompt"]#,"prompt_muons_iso_dr01","non_prompt_muons_iso_dr01","prompt_electrons_iso_dr01","non_prompt_electrons_iso_dr01","prompt_muons_iso_dr02","non_prompt_muons_iso_dr02","prompt_electrons_iso_dr02","non_prompt_electrons_iso_dr02"]#],"prompt_muons_iso_dr03","non_prompt_muons_iso_dr03","prompt_electrons_iso_dr03","non_prompt_electrons_iso_dr03"]

# rebin = [1, 1, 1, 1, 2] # uniform rebin per variable (optional)

### Dictionary with the analysis name as a key, and the list of selections to be plotted for this analysis. The name of the selections should be the same than in the final selection
selections = {}
selections['ttZ_analysis']   = ["all_events"]#,"Zee","Zmm"]#,"lep_eta","lep_pt","lep_eta_pt"]#,"sel5_second_pair"]
