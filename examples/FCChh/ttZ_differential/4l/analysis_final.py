...
inputDir = "/eos/user/l/lberiet/ttZ_diff_results/final2/"
#inputDir = "/eos/user/s/selvaggi/analysis/ttbar_diff"

# Input directory where the files produced at the pre-selection level are
outputDir = "/eos/user/l/lberiet/ttZ_diff_results/final2/"
...
histoList = {
   ...
   # "n_jets" : {"name": "n_jets", "title": "Number of Jets", "bin": 20, "xmin": 0, "xmax":20},
    "Z_ll_pt" : {"name": "Z_ll_pt", "title": "pt of Z_ll", "bin": 50, "xmin": 0, "xmax": 200},
    "wp_eleId": {"name": "wp_eleId", "title": "wp_eleId", "bin": 10, "xmin": 0, "xmax": 10},
    "wm_eleId": {"name": "wm_eleId", "title": "wm_eleId", "bin": 10, "xmin": 0, "xmax": 10},
    "wp_muId": {"name": "wp_muId", "title": "wp_muId", "bin": 10, "xmin": 0, "xmax": 10},
    "wm_muId": {"name": "wm_muId", "title": "wm_muId", "bin": 10, "xmin": 0, "xmax": 10},
    "wp_bjetId": {"name": "wp_bjetId", "title": "wp_bjetId", "bin": 10, "xmin": 0, "xmax": 10},
    "wm_bjetId": {"name": "wm_bjetId", "title": "wm_bjetId", "bin": 10, "xmin": 0, "xmax": 10},
