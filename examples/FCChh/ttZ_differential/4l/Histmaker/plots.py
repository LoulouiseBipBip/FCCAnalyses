...
outdir = "/eos/user/l/lberiet/ttZ_diff_results/new_iso_noORL/plot_iso_hadrons"
inputDir = "/eos/user/l/lberiet/ttZ_diff_results/new_iso_noORL"
...
hists["cutFlow"] = {
    ...
    # "xtitle": selections,
    "ytitle": "Events",
    "processes": ["ttZ", "tttt", "ZZjj", "VVV", "VVVV", "ttV", "ttVV", "ttH", "WZjj", "tt"],
}
...
hists['Z_ll_pt_stack'] = {
    ...
    "ymax": 1e3,
    'ytitle': 'Events / GeV',
    'processes': ["ttZ", "tttt", "ZZjj", "VVV", "VVVV", "ttV", "ttVV", "ttH", "WZjj", "tt", "ttW"],
    'density': False,
    'divideByBinWidth': True,
    'rebin_last': True,
    'store_csv': True,
