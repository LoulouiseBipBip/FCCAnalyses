...
def main():
    ...
    input_dir = "/eos/user/l/lberiet/Histmaker/tta/final/"
    hist_name = "dR_lep_b_reco_vs_leading_photon_pt_reco"  # Ensure this matches the 2D histogram name in analysis_final.py
    
    # List of Q-binned processes to handle
    processes = [
          "mgp8_pp_tta_Q_200_1000_5f_84TeV",  
        "mgp8_pp_tta_Q_1000_3000_5f_84TeV",
        "mgp8_pp_tta_Q_3000_5000_5f_84TeV",
        "mgp8_pp_tta_Q_5000_15000_5f_84TeV",
        "mgp8_pp_tta_Q_15000_84000_5f_84TeV",
    ]
    
    output_dir = "/eos/user/l/lberiet/Histmaker/tta/plots"
    ...
    for proc in processes:
        ...
        if combined_hist is None:
            ...
            combined_hist.SetTitle("Combined Q-binned dR_lep_b_reco_vs_leading_photon_pt_reco")
            combined_hist.GetXaxis().SetTitle("dR")  # Ensure x-axis title is set correctly
            combined_hist.GetYaxis().SetTitle("pT photon")  # Ensure y-axis title is set correctly
