...
outdir = "/eos/user/l/lberiet/www/4t_analysis/4l/SS_OF=4"
plotStatUnc = True
...
selections = {}
selections['tttt_analysis']   = ["all_events","sel_SS_OF=4","sel1_lep","sel2_bjets","sel3_jets","sel4_notZ"]

extralabel = {}
extralabel['all_events'] = "All events" 
extralabel['sel_SS_OF=4'] = "Sel SS OF=4"
