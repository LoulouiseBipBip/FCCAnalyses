...
outputDir = "/eos/user/l/lberiet/ttttResult"
...
bins_ht = array.array('d', [0.5, 0.75, 1, 1.5, 2.5, 5, 10, 20, 50])
...
def build_graph(df, dataset):
    ...
    # calculate HT
    df = df.Define("HT", "pT_leptons_sel[0] + pT_leptons_sel[1] + sel_bjets_pt[0] + sel_bjets_pt[1] + sel_bjets_pt[2]")
