...
outdir = "/eos/user/l/lberiet/www/4t_analysis/4l"
plotStatUnc = True


variables = ['n_bjets', 'n_leptons', 'HT', 'MET', 'n_of_ss_sf_leptons', 'n_jets', 'Z_ll_mass', 'Second_Pair_mass', 'dR_ll']

# rebin = [1, 1, 1, 1, 2] # uniform rebin per variable (optional)

### Dictionary with the analysis name as a key, and the list of selections to be plotted for this analysis. The name of the selections should be the same than in the final selection
selections = {}
selections['tttt_analysis']   = ["all_events","sel1_lep","sel2_bjets","sel3_jets","sel4_notZ"]
