...
df_3l = pd.read_csv('/eos/user/l/lberiet/www/Histograms_Syst/4t/3l/HT_stack_uncertainties.csv')
df_4l = pd.read_csv('/eos/user/l/lberiet/www/Histograms_Syst/4t/4l/HT_stack_uncertainties.csv')
...
# Extract the number of signal events for each bin (tttt as signal)
...
for i in range(min_length):
    ...
    # Calculate total background events for the bin by summing all background category columns except tttt
...
results_per_bin.to_csv('/eos/user/l/lberiet/www/Histograms_Syst/4t/combined/combined_uncertainties_per_bin_tttt.csv', index=False)
...
overall_results.to_csv('/eos/user/l/lberiet/www/Histograms_Syst/4t/combined/combined_uncertainties_overall_tttt.csv', index=False)

print("Per-bin results saved to '/eos/user/l/lberiet/www/Histograms_Syst/4t/combined/combined_uncertainties_per_bin_tttt.csv'")
print("Overall results saved to '/eos/user/l/lberiet/www/Histograms_Syst/4t/combined/combined_uncertainties_overall_tttt.csv'") 