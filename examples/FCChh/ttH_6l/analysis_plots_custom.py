...
ana_tex        = 'pp #rightarrow ttH'
delphesVersion = '3.4.2'
energy         = 84
collider       = 'FCC-hh'
inputDir       = '/eos/user/l/lberiet/ttH/final/'
formats        = ['png'] #['png','pdf']
yaxis          = ['lin','log']
...
legend = {}
legend['ttH_signal'] = 'ttH'
legend['4t_bkg'] = '4t'
legend['ttZ_bkg_lep'] = 'ttZ'
