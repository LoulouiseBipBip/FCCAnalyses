...
outdir = "/eos/user/l/lberiet/Histmaker/WZ/plotsnewiso"
inputDir = "/eos/user/l/lberiet/Histmaker/WZ"
...
colors = {}
colors["WZ"] = ROOT.kBlack
colors["ttZ"] = custom_color_indices[0]
colors["tttt"] = custom_color_indices[1]
colors["ZZ"] = custom_color_indices[2]
colors["VVV"] = custom_color_indices[3]
colors["VVVV"] = custom_color_indices[4]
colors["ttV"] = custom_color_indices[5]
colors["ttVV"] = custom_color_indices[6]
colors["ttW"] = custom_color_indices[7]
colors["ttH"] = custom_color_indices[8]
...
colors["ttW"] = custom_color_indices[10]
colors["Z+j"] = custom_color_indices[11]
...
procs["signal"] = {
    "WZ": ["mgp8_pp_wz_5f_Q_0_1000_84TeV_wzlllv",
    "mgp8_pp_wz_5f_Q_1000_3000_84TeV_wzlllv",
    "mgp8_pp_wz_5f_Q_3000_10000_84TeV_wzlllv",
    "mgp8_pp_wz_5f_Q_10000_84000_84TeV_wzlllv",],
    }
procs["backgrounds"] = {
    ...
    'ZZ': ["mgp8_pp_zz_llll_Q_200_1000_5f_84TeV",
    "mgp8_pp_zz_llll_Q_1000_3000_5f_84TeV",
    "mgp8_pp_zz_llll_Q_3000_10000_5f_84TeV",
    "mgp8_pp_zz_llll_Q_10000_84000_5f_84TeV"],
...
hists["cutFlow"] = {
    ...
    # "xtitle": selections,
    "ytitle": "Events",
    "processes": ["WZ", "ttZ", "tttt", "ZZ", "VVV", "VVVV", "ttV", "ttVV", "ttW", "ttH_WW", "ttH_tauTau", "ttH_ZZ", "tt", "Z+j"],
}
...
hists["n_bjets_pre_norm"] = {
    ...
    "xmax": 10.5,
    "ytitle": "Events",
    "processes": ["WZ", "ttZ", "tttt", "ZZ", "VVV", "VVVV", "ttV", "ttVV", "ttW", "ttH", "WZjj", "tt", "Z+j"],
    "density": True,
}
